...
return function (\CL\Course\Handbook $handbook) {
	...
	$handbook->title = 'Course Handbook';
...
RUBRIC;
    ...
    $category = $handbook->add_category("sanity", "Sanity Check", 4);
    $category->rubric = <<<RUBRIC
	<p>1 point if 1-2 sanity check warnings, 2 if 3-5,
	3 if 6-8, 4 if more than 8.</p>
RUBRIC;
...
RUBRIC;
    ...
    $category->rubric = <<<RUBRIC
<p>Don't count off for warnings about the use of override. That warning only occurs on Macs</p>
RUBRIC;
